...
const styles = StyleSheet.create({
  ...
  cardTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginTop: 15 }, cardTitle: { color: colors.ink, fontSize: 18, fontWeight: "800" }, meta: { color: colors.muted, fontSize: 12, marginTop: 4 }, caption: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 14 },
});
