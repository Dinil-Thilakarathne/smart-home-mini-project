...
export default function ActivityScreen() {
  ...
  async function downloadLogs() {
    ...
    try { await downloadDeviceLogPdf(visibleLogs, selectedDeviceName); Toast.show({ type: "success", text1: "PDF downloaded", text2: "The audit log was saved to your selected folder." }); }
  ...
  async function shareLogs() {
    setExporting("share");
    try { await shareDeviceLogPdf(visibleLogs, selectedDeviceName); Toast.show({ type: "success", text1: "PDF ready to share", text2: "Choose an app or contact to send the audit log." }); }
